...
let UsersController = class UsersController {
    ...
    getUserWithMovies(id) {
        return this.usersService.getUserWithMovies(+id);
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obtener películas vistas por un usuario' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "getUserWithMovies", null);
